    ...
    <div class="container">
        ...
        <div class="day-container">
            <div class="datanav1">
                ...
                <div class="datenav1">2024-08-26(월)</div>
            </div>
            ...
            <div class="timeline-container">
                <div class="timeline-container">
                        ...
                        <div class="time-content">
                            ...
                            <div class="asd123">
                                <div class="datanav3">
                                    ...
                                    <div class="time-title">제주국제공항</div>
                                </div>
                                <div><img class="imgdiv1" src="./다운로드 (1).jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="time-content">
                            <div class="time-date">11:37-12:25</div>
                            <div class="asd123">
                                <div class="datanav3">
                                    <div class="pcolor">명소</div>
                                    <div class="time-title">관광지 2</div>
                                </div>
                                <div><img class="imgdiv1" src="./다운로드 (1).jpg" alt=""></div>
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="time-content">
                            <div class="time-date">13:00-13:30</div>
                            <div class="asd123">
                                <div class="datanav3">
                                    <div class="pcolor">명소</div>
                                    <div class="time-title">관광지 3</div>
                                </div>
                                <div><img class="imgdiv1" src="./다운로드 (1).jpg" alt=""></div>
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="time-content">
                            <div class="time-date">14:00-14:30</div>
                            <div class="asd123">
                                <div class="datanav3">
                                    <div class="pcolor">명소</div>
                                    <div class="time-title">관광지 4</div>
                                </div>
                                <div><img class="imgdiv1" src="./다운로드 (1).jpg" alt=""></div>
                            </div>
                        </div>
        ...
        <div class="day-container">
            <div class="datanav1">
                <div class="date1">2일차</div>
                <div class="datenav1">2024-08-27(화)</div>
            </div>
        ...
        <div class="day-container">
            <div class="datanav1">
                <div class="date1">3일차</div>
                <div class="datenav1">2024-08-28(수)</div>
            </div>
